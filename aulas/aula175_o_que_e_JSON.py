...
# É uma estrutura de dados que permite a serialização de objetos
#em texto simples para facilitar a transmissão de dados através da rede, APIs web ou outros meios de comunicação.
# O JSON suporta os seguintes tipos de dados:
# NÚMEROS: Podem ser inteiros ou com ponto flutuante, como 42 ou 3.14
# STRINGS: São cadeias de caracteres, como "Olá, Mundo!" ou "12365"
